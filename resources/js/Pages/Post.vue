        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                    ...
                    <div class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md my-3" role="alert" v-if="flash.message">
                      <div class="flex">
                        <div>
                          ...
                          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="">
                                  ...
                                  <div class="mb-4">
                                      ...
                                      <div v-if="errors.body" class="text-red-500">{{ errors.body[0] }}</div>
                                  </div>
                            </div>
                          </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            save: function (data) {
                this.$inertia.post('/post/create', data)
                this.reset();
                this.closeModal();
                this.editMode = false;
            },
            ...
            update: function (data) {
                data._method = 'PUT';
                this.$inertia.post('/post/update/' + data.id, data)
                this.reset();
                this.closeModal();
            },
            deleteRow: function (data) {
                ...
                data._method = 'DELETE';
                this.$inertia.post('/post/destroy/'+ data.id, data)
                this.reset();
                this.closeModal();
            }
        }
